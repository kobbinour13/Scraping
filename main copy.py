...
browser.find_element('id','username').send_keys('nour.kobbi@gmail.com') #Enter username of linkedin account here
browser.find_element('id','password').send_keys('1212tki76')  #Enter Password of linkedin account here
browser.find_element(By.XPATH,"//*[@type='submit']").click();

link = "https://www.linkedin.com/in/sami-thabet-08069986/"
browser.get(link)
...
for line in file_contents.splitlines():
    ...
    if not start_flag and (("yr" in line) or ("yrs" in line)):
        start_flag = True
